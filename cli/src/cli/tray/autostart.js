...
const APP_LABEL = "com.afrouter.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when afrouter is currently
 ...
 * SIGTERM to the running process. When the running afrouter cli.js was itself
...
<dict>
    ...
    <string>/tmp/afrouter.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/afrouter.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `afrouter.cmd` lookup that depended on the npm prefix path.
