...
AFRouter es compatible con cualquier herramienta que soporte el formato de API de OpenAI. Esta guía cubre patrones de integración genéricos para varias herramientas y aplicaciones personalizadas.

## Resumen

AFRouter proporciona un endpoint de API compatible con OpenAI que funciona con:
...
Cualquier herramienta compatible con OpenAI puede conectarse a AFRouter usando estas configuraciones:

**AFRouter local:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de AFRouter (cc/*, cx/*, glm/*, etc.)
```
...
**Problema:** No se puede conectar a AFRouter
```bash
# Verifica si AFRouter está corriendo
...
**Solución:**
- Verifica que AFRouter esté corriendo
...
- Verifica la conexión de red a AFRouter
