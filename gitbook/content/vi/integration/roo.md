...
Tích hợp AFRouter với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
Chọn từ các model AFRouter có sẵn:
...
### Connection Failed
- Xác minh AFRouter đang chạy: `curl http://localhost:20128/health`
