...
Ejecuta AFRouter en tu máquina local para desarrollo y uso personal.

---

## 📦 Instalación

Instala AFRouter globalmente vía npm:
...
Inicia AFRouter con un solo comando:
...
Presiona `Ctrl+C` en la terminal donde AFRouter se está ejecutando.

```bash
# En la terminal ejecutando afrouter
^C  # Presiona Ctrl+C
```
