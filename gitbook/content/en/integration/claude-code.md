...
Integrate AFRouter with Claude Code CLI to route your Anthropic API requests through AFRouter's intelligent routing system.
...
Claude Code supports the following model aliases that map to AFRouter models:
