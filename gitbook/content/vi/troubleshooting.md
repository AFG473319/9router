...
Các vấn đề và giải pháp phổ biến khi dùng AFRouter.
...
1. **Auto-refresh (mặc định):**
   AFRouter tự refresh tokens. Đợi 30 giây rồi thử lại.
...
1. **Kiểm tra AFRouter có chạy không:**
   ```bash
   # Check process
