...
Hướng dẫn cài đặt chi tiết cho AFRouter với mẹo troubleshooting.
...
Cài AFRouter toàn cục để dùng ở bất kỳ đâu:
...
**Lợi ích:**
- ✅ Chạy từ mọi thư mục
- ✅ Lệnh đơn giản: `afrouter`
- ✅ Auto-update với `npm update -g afrouter`
...
3. Data directory được tạo tại `~/.afrouter`
...
**Vấn đề:** AFRouter dùng quá nhiều RAM
