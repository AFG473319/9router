...
Common issues and solutions when using AFRouter.
...
1. **Auto-refresh (default):**
   AFRouter automatically refreshes tokens. Wait 30 seconds and retry.
...
1. **Check if AFRouter is running:**
   ```bash
   # Check process
