...
AFRouter is compatible with any tool that supports the OpenAI API format. This guide covers generic integration patterns for various tools and custom applications.

## Overview

AFRouter provides an OpenAI-compatible API endpoint that works with:
...
Any OpenAI-compatible tool can connect to AFRouter using these settings:

**Local AFRouter:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: any AFRouter model (cc/*, cx/*, glm/*, etc.)
```
...
**Problem:** Cannot connect to AFRouter
```bash
...
- Check network connection to AFRouter
