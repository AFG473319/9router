 ...
 * API. They are afrouter fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic afrouter variant set for a single upstream Kiro model.
 *
 ...
 * into afrouter variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
