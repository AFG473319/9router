...
Integrate AFRouter with Cline VSCode extension to route your AI requests through AFRouter's intelligent routing system.
...
Set the base URL to your AFRouter endpoint:
...
**Steps:**
1. In the **Base URL** field, enter your AFRouter endpoint
...
3. The key should start with `sk-afrouter-`

### 5. Select Model

1. In the **Model** dropdown, you can either:
   - Select from available models (if Cline auto-detects them)
   - Manually enter the model name from your AFRouter configuration
...
4. Cline will use AFRouter to process your request

### Code Generation

1. Ask Cline to generate code: "Create a React component for a login form"
2. Cline will generate code using AFRouter
...
3. Get AI-powered explanations through AFRouter

### File Operations

1. Ask Cline to create, modify, or delete files
2. Cline will use AFRouter to understand context and make changes
...
2. Verify your AFRouter instance is running and healthy
3. Try reloading VSCode window (Cmd/Ctrl + Shift + P → "Reload Window")
4. Check AFRouter logs for any errors
...
2. Make sure you have configured your API key in the AFRouter cloud dashboard
...
## Integration with AFRouter Features

### Model Routing

AFRouter automatically routes your requests to the best available provider based on:
- Model availability
...
If a provider fails, AFRouter automatically falls back to alternative providers configured in your dashboard.

### Usage Tracking

Monitor your Cline usage through AFRouter dashboard:
- Total requests
- Token usage
- Cost per model
