...
Tích hợp AFRouter với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.

## Yêu cầu

- Visual Studio Code đã cài đặt
- Extension Continue đã cài đặt từ VSCode marketplace
- AFRouter API key từ [dashboard](https://9router.com/dashboard)
- AFRouter đang chạy (cục bộ hoặc cloud)
...
### 2. Thêm Cấu hình Model AFRouter
...
3. Chọn model AFRouter ưa thích
...
- Kiểm tra AFRouter đang chạy: `curl http://localhost:20128/health`
...
- Kiểm tra độ trễ network đến AFRouter
