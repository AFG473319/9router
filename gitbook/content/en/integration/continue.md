...
Integrate AFRouter with Continue extension to bring AI assistance directly into Visual Studio Code.

## Prerequisites

- Visual Studio Code installed
- Continue extension installed from VSCode marketplace
- AFRouter API key from [dashboard](https://9router.com/dashboard)
- AFRouter running (local or cloud)
...
### 2. Add AFRouter Model Configuration
...
3. Choose your preferred AFRouter model
...
- Check network latency to AFRouter
