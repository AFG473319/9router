...
AFRouterをClaude Code CLIと統合し、AnthropicのAPIリクエストをAFRouterのインテリジェントルーティングシステム経由でルーティングします。
...
Claude CodeはAFRouterモデルにマッピングされる以下のモデルエイリアスをサポート:
