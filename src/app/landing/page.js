    ...
    <div className="relative text-white font-sans overflow-x-hidden antialiased selection:bg-[#3B82F6] selection:text-white">
      ...
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none bg-[#0B1120]">
        ...
        <div className="absolute inset-0" style={{
          background: 'radial-gradient(circle at center, transparent 0%, rgba(5, 8, 15, 0.4) 100%)'
        }}></div>
      </div>
      ...
      <div className="relative z-10">
        ...
        <section className="py-32 px-6 relative overflow-hidden">
          <div className="absolute inset-0 bg-linear-to-t from-[#3B82F6]/5 to-transparent pointer-events-none"></div>
          <div className="max-w-4xl mx-auto text-center relative z-10">
            <h2 className="text-4xl md:text-5xl font-black mb-6">Ready to Simplify Your AI Infrastructure?</h2>
            <p className="text-xl text-gray-400 mb-10 max-w-2xl mx-auto">
              Join developers who are streamlining their AI integrations with AFRouter. Open source and free to start.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button 
                onClick={() => router.push("/dashboard")}
                className="w-full sm:w-auto h-14 px-10 rounded-lg bg-[#3B82F6] hover:bg-[#2563EB] text-white text-lg font-bold transition-all shadow-[0_0_20px_rgba(59,130,246,0.5)]"
              >
                Start Free
              </button>
              <button 
