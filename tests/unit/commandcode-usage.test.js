...
describe("getCommandCodeUsage", () => {
  ...
  it("maps credit windows and the monthly allowance to quotas", async () => {
    ...
    expect(out.quotas["5-hour"].total).toBe(16);
    ...
    expect(out.quotas.Weekly.total).toBe(40);
    ...
    expect(monthly.used).toBeCloseTo(12.3759038402, 4);
    expect(monthly.total).toBeCloseTo(80.0225921017, 4);
