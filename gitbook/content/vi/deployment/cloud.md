...
Triển khai AFRouter trên VPS hoặc Docker để truy cập từ xa và dùng trong production.
...
| `DATA_DIR` | `~/.afrouter` | Đường dẫn lưu database và data |
...
Tạo `/etc/nginx/sites-available/afrouter`:
...
# If NOT using reverse proxy, allow AFRouter ports
