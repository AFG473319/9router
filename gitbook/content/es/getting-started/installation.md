...
Guía detallada de instalación de AFRouter con consejos de solución de problemas.
...
Instala AFRouter globalmente para usar desde cualquier lugar:
...
- ✅ Comando simple: `afrouter`
- ✅ Auto-actualizaciones con `npm update -g afrouter`
...
3. Se crea el directorio de datos en `~/.afrouter`
...
**Ubicación por defecto:** `~/.afrouter`
...
**Error:**
```
Error: EACCES: permission denied, mkdir '/usr/local/lib/node_modules/afrouter'
```
...
**Problema:** AFRouter usa demasiada RAM
...
```bash
npm install -g pm2
pm2 start afrouter --name afrouter
pm2 save
```
...
```bash
docker pull afrouter/afrouter:latest

docker run -d \
  -p 20128:20128 \
  -e JWT_SECRET="your-secure-secret" \
  -e INITIAL_PASSWORD="your-password" \
  -v afrouter-data:/root/.afrouter \
  --name afrouter \
  afrouter/afrouter:latest
```
...
nano ~/.bashrc  # o ~/.zshrc
# Eliminar exports relacionados con afrouter
```
