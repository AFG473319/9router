...
The same matrix applies to afrouter's virtual `-review` variants because they
...
- Adding Codex Ultra's multi-agent orchestration behavior inside afrouter;
  afrouter only forwards the catalog-advertised reasoning override.
