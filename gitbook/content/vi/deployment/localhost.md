...
Chạy AFRouter trên máy cá nhân để phát triển và dùng cá nhân.

---

## 📦 Cài đặt

Cài đặt AFRouter toàn cục qua npm:
...
Khởi động AFRouter với một lệnh duy nhất:
...
Nhấn `Ctrl+C` trong terminal đang chạy AFRouter.
