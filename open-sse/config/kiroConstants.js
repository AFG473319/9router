 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what afrouter needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a afrouter
 ...
 * The suffix is a afrouter request override, not part of Kiro's upstream model id.
 */
...
/**
 * Detect whether a model id refers to a afrouter synthetic agentic variant.
...
/**
 * Detect whether a model id is a afrouter synthetic thinking variant
...
/**
 * Resolve a afrouter model id to the real upstream Kiro model id, plus flags
