...
Problemas comunes y soluciones al usar AFRouter.
...
1. **Refresh automático (por defecto):**
   AFRouter refresca automáticamente los tokens. Espera 30 segundos y reintenta.
...
1. **Verifica si AFRouter está ejecutándose:**
   ```bash
   # Verifica el proceso
   ps aux | grep afrouter
...
- **GitHub Issues:** [github.com/AFG473319/AFRouter/issues](https://github.com/AFG473319/AFRouter/issues)
