        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-400 text-lg mb-8">
              Install AFRouter, configure your providers via web dashboard, and start routing AI requests.
            </p>
            
            <div className="flex flex-col gap-6">
              <div className="flex gap-4">
                <div className="flex-none w-8 h-8 rounded-full bg-[#3B82F6]/20 text-[#60A5FA] flex items-center justify-center font-bold">1</div>
                <div>
                  <h4 className="font-bold text-lg">Install AFRouter</h4>
                  <p className="text-sm text-gray-500 mt-1">Run npx command to start the server instantly</p>
                </div>
              </div>
              
              <div className="flex gap-4">
                <div className="flex-none w-8 h-8 rounded-full bg-[#3B82F6]/20 text-[#60A5FA] flex items-center justify-center font-bold">2</div>
                <div>
          ...
          <div className="flex-1 w-full">
            <div className="rounded-xl overflow-hidden bg-[#0D1420] border border-[#24344F] shadow-2xl">
              {/* Terminal header */}
              <div className="flex items-center gap-2 px-4 py-3 bg-[#121A2B] border-b border-gray-700">
              ...
              <div className="p-6 font-mono text-sm leading-relaxed overflow-x-auto">
                <div 
                  ...
                  onClick={() => handleCopy("npx afrouter")}
                >
                  <span className="text-green-400">$</span>
                  <span className="text-white">npx afrouter</span>
                ...
                <div className="text-gray-400 text-xs">
                  ...
                  <span className="text-gray-500">  macOS/Linux:</span> ~/.afrouter/db/data.sqlite<br/>
                  <span className="text-gray-500">  Windows:</span> %APPDATA%/afrouter/db/data.sqlite
                </div>
              </div>
            </div>
          </div>
