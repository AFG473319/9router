...
Integra AFRouter con OpenAI Codex CLI para enrutar tus solicitudes de la API de OpenAI a través del sistema de enrutamiento inteligente de AFRouter.
...
AFRouter proporciona los siguientes modelos de Codex:
...
1. Verifica que tu API key sea correcta en el dashboard de AFRouter
...
1. Verifica que el nombre del modelo coincida con tu configuración de AFRouter
2. Verifica que la conexión del proveedor de OpenAI esté activa en el dashboard de AFRouter
...
Asegúrate de haber configurado tu API key en el dashboard en la nube de AFRouter.
